...
const Services = () => {
  ...
  return (
                ...
                <div class="col-xl-8 col-lg-12">
                    <div class="choose-text">
                        ...
                        <h2 class="choose-subtitle">With Fidelity Stock...</h2>
                                  <p class="choose-title-describe">Our service gives you a better crypto trading experience, with lots of profits attatched. Fidelity Stock is the best place for you to trade. We are your perfect choice for a better crypto trading experience.
    ...
    <div class="single-item">
        ...
        <div class="text-box">
            <h2 class="single-item-title">Weekly Income</h2>
				...
				<div className="col-lg-5">
					<div className="section-heading">
						...
						<h3><strong>Our Investment Benefits</strong></h3>
                          ...
                          <p class="investment-title-describe"> Check out our Mining options on our invesment page and choose the best option for yourself. Once your payment is confirmed, you’ll start mining immediately. You can start with Classic plan if you want and upgrade later.
 </p>

              </div>
              <div className="col-lg-7">
					<img src={service} alt="Image placeholder" className="img-fluid" />
				</div>
			</div>
