  ...
  return (
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-12">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Create User Accounts</h3></div>
                                    <div class="card-body">
    ...
    <select className="form-control" name='role' value={data.role} onChange={handleChange}>
      ...
      <option>Admin</option>
                        ...
                        <input type="submit" value="Create User Account" className="btn btn-info btn-md text-white"  />
